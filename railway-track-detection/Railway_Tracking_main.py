...
def main():
    ...
    parser.add_argument('-I', "--input", help="input file video", default="new vid.mp4")
    ...
    parser.add_argument('--imgSizeX', type=int, help="image size along x", default=450)
    parser.add_argument('--imgSizeY', type=int, help="image size along Y", default=360)
    parser.add_argument('--tmpWidth', type=int, help="start template width", default=9)
    parser.add_argument('--tmpHeight', type=int, help="start template height", default=3)
    parser.add_argument('--startLeftRailGuess', type=int, help="Guess for determining the position within the lower part"
                                                               " of the image of the left rail", default=180)
    parser.add_argument('--startRightRailGuess', type=int, help="Guess for determining the position within the lower part"
                        " of the image of the right rail", default=280)
